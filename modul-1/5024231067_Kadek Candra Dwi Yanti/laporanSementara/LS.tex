...
\usepackage[utf8]{inputenc}  % Pastikan input encoding yang benar
\usepackage[english]{babel}  % Menggunakan bahasa Indonesia
\usepackage{float}
\usepackage{verbatim}
...
\usepackage{csquotes}  % Menambahkan csquotes untuk kutipan

% Definisi warna dan lainnya
...
\def\nama{Kadek Candra Dwi Yanti - 5024231067}
